...
from .views import AnswerQuestions, Certificate, MyTokenObtainPairView, PasswordChange, QuestionsView, ScorerView, UserViewSet
...
urlpatterns = [
    ...
    path('questions/<str:school>/<int:pk>/answered', ScorerView.as_view()),
